...
package mox.signals 
{
    ...
    /**
     * A global signal system in one function.
     * 
     * @param sig the name of the signal to work with. Typically a String.
     * Can be the char '*' or a RegExp when the op parameter is 0 or strictly 
     * lesser than 0.
     * @param callee the function to work with. Can be the char '*' when 
     * the op parameter is 0 or strictly lesser than 0.
     */
